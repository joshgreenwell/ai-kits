...
- **[Usage: features and verified current state](docs/usage-system.md)**
- [V2 collection and operation](docs/usage-collection.md), with collection modes at `/settings/collection` and installs at `/settings`; the companion lives in [`companion/`](companion/README.md)
- [V1 data preservation, migration, and complete removal](docs/usage-v1-retirement.md)
...
The old usage site is temporarily read once daily for reports from computers not yet migrated. Claude's daily readings run as a scheduled task on this Mac at 9:00 AM Central and publish directly. See the schedule registry for operational dependencies and retirement steps.

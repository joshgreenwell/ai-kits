...
- [V2 collection and operation](docs/usage-collection.md), with collection modes at `/usage/settings` and installs at `/usage/connections`; the companion lives in [`companion/`](companion/README.md)

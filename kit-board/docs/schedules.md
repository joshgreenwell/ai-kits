...
- Windows v2 runs hourly at minute 10. A 5:32 PM Central Task Scheduler invocation after publication recovery exited `0`, accepted six buckets and one request record with no rejections, and published the changed detailed report. The next natural trigger was still scheduled for 6:10 PM. Two old v1 tasks remain enabled and fail at minute 7. They have **not** been uninstalled.

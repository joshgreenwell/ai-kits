...
| Allowances | `/usage/allowances` | Per-account allowance windows and model history from `/api/usage-live`; the reset calendar stays at `/usage/resets` until USG-024 |

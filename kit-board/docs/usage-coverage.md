...
| Effort, speed, service tier | `effort`, `usage.speed`, `usage.service_tier` | n/a | OTel `speed`, `effort` | n/a | `maxMode` | `service_tier`, `speed` | `service_tier` | `activity.request.pricing`, `account.usage_bucket.dimensions.pricing` | Contract and storage ready; collection is USG-004 |

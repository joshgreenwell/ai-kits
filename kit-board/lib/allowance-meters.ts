 ...
 * the two may differ and then show as separate meters. `extra_usage` is a browser-only meter.
 * Codex keys (`<limit>:<minutes>`, Spark windows) keep the producer's label.
 */
